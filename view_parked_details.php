		...
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-6">
						<?php if($status == 1): ?>
							<button type="button" id="checkout_btn" class="btn-sm btn btn-block col-sm-5 btn-primary"><i class="fa fa-calculator"></i> Checkout</button>
						...
						<?php else: ?>
							<table class="table table-bordered" width="100%">
								...
								<tr>
									<th>Tarif per Jam Jenis Kendaraan</th>
