...
<script>
	$('#new_location').click(function(){
		uni_modal("Tambah Lokasi Kendaraan","manage_location.php")
	})
	
	$('.edit_location').click(function(){
		uni_modal("Edit Lokasi Kendaraan","manage_location.php?id="+$(this).attr('data-id'))
		
	})
	$('.delete_location').click(function(){
		_conf("Apakah Anda yakin?","delete_location",[$(this).attr('data-id')])
	})
