...
<div class="container-fluid mt-4">
	<div class="card">
		<div class="card-header">
			<span><b><?php echo isset($id) ? "Manage" : "New" ?> Kendaraan</b></span>
		</div>
		<div class="card-body">
			<form action="" id="manage-vehicle"> 
				...
				<div class="col-lg-12">
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Jenis Kendaraan</label>
...
<select name="location_id" id="location_id" class="custom-select select2" required=>
					...
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Deskripsi Kendaraan</label>
